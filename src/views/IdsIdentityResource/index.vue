<template>
    <div id="div_IdsIdentityResource">
...
// 枚举类型字段
export default {
  name: 'IdsIdentityResource', // 页面名称（当组件引用时用到）
  ...
  data () {
    ...
    let SetArrField = [
      ...
      // { Name: 'Properties', DisplayName: '属性', Width_List: '120', Width_input: '378', Type: 'string', Precision: null, inputType: 'tagedit', IsKey: false, Required: false, Sortable: false, Editable: true, SearchShow: false, FormShow: true, ListShow: false, MaxLength: 0, MinLength: 0, ListOrder: 0, SearchOrder: 0, FormOrder: 6, IsForeignKey: false, ForeignKeyGetListUrl: null }
    ]
    return {
      Fields: SetArrField,
      controllerName: 'IdentityResource' // CRUD控制器
    }
  }
}
</script>
